...
The main branch is using `spring-boot 2.7.x` and `spring-cloud 2021.0.x`. Check https://github.com/spring-cloud-services-samples/cook/tree/spring-boot-2.6/[spring-boot-2.6], https://github.com/spring-cloud-services-samples/cook/tree/spring-boot-2.5/[spring-boot-2.5] and https://github.com/spring-cloud-services-samples/cook/tree/spring-boot-2.4/[spring-boot-2.4] branches for older versions.
